...
echo "    - Reverb: php artisan reverb:start (Supervisor/systemd in production)"
echo "    - Traccar forward: TRACCAR_BROADCAST_MODE=forward + traccar.xml → https://gpsbillx.com/api/traccar/forward"
echo "    - Verify: php artisan traccar:forward-status"
