...
const FILES = [
    ...
    { in: path.join(SOURCE_DIR, 'builtin-map-icons.js'), out: 'builtin-map-icons.js' },
    { in: path.join(SOURCE_DIR, 'vehicle-marker.js'), out: 'vehicle-marker.js' },
    { in: path.join(SOURCE_DIR, 'map-marker-appearance.js'), out: 'map-marker-appearance.js' },
    ...
    { in: path.join(SOURCE_DIR, 'polyline-simplify.js'), out: 'polyline-simplify.js' },
