    ...
    protected function mapApiRoutes(Device $device, string $mapToken): array
    {
        ...
        if ($this->isAdminMapRequest()) {
            ...
            return [
                ...
                'historyPoints' => route($panel . '.device.history.points.json', $token),
                'historyAnalytics' => route($panel . '.device.history.analytics.json', $token),
                ...
                'restartTrip' => route($panel . '.device.restart.trip', $token),
        ...
        return [
            ...
            'historyPoints' => route('user.device.history.points.json', $token),
            'historyAnalytics' => route('user.device.history.analytics.json', $token),
            ...
            'restartTrip' => route('user.device.restart.trip', $token),
