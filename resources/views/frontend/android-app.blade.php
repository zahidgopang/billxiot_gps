...
@php
    $steps = [
        [
            'number' => 1,
            'title' => 'Download the BillX GPS APK',
            'body' => 'Tap the download button below. Your browser will save BillXGPS.apk to your Downloads folder.',
            'icon' => 'fa-download',
        ],
        [
            'number' => 2,
            'title' => 'Open the downloaded file',
            'body' => 'Open your Downloads folder or notification shade and tap BillXGPS.apk to start installation.',
            'icon' => 'fa-folder-open',
        ],
        [
            'number' => 3,
        ...
        [
            ...
            'body' => 'Follow the on-screen prompts, then tap Open or find BillX GPS on your home screen and sign in.',
    ...
    $faqs = [
        ...
        [
            'q' => 'Is BillX GPS malware?',
            'a' => 'No. BillX GPS is our official GPS tracking application distributed through our official website.',
        ],
        [
    ...
    <section class="relative overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
            ...
            <h1 class="text-4xl sm:text-5xl font-bold mb-4">
                Download <span class="bg-gradient-to-r from-sky-500 to-blue-600 bg-clip-text text-transparent">BillX GPS</span>
            </h1>
    ...
    <section class="py-12 sm:py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-slate-600 dark:text-slate-400 leading-relaxed">
                            BillX GPS is currently distributed directly from our official website and is not yet published on Google Play Store. Because of this, Android may display a Play Protect or Unknown App warning. This is expected for direct APK installations.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-emerald-900/80 dark:text-emerald-200/90 leading-relaxed">
                            Please download BillX GPS only from the official website:
            ...
            <div id="download" class="p-8 sm:p-10 rounded-2xl glass border border-slate-200 dark:border-slate-800 text-center">
                ...
                <h2 class="text-2xl font-bold mb-2">Download BillX GPS APK</h2>
