...
@section('description', 'Complete API documentation for BillX GPS integration and development.')
            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <span class="inline-block px-4 py-1.5 bg-gradient-to-r from-indigo-500/10 to-violet-500/10 rounded-full text-indigo-600 dark:text-indigo-400 font-semibold text-sm mb-4">
                    ...
                    <p class="text-xl text-slate-600 dark:text-slate-300">
                        Complete documentation for BillX GPS REST API. Integrate fleet data into your applications.
                    </p>
                </div>
    ...
    <section class="py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                ...
                <p class="text-slate-600 dark:text-slate-400">Get started with BillX GPS API in minutes</p>
            </div>
                ...
                <div class="flex items-start gap-6">
                    ...
                    <div class="flex-grow">
                        ...
                        <p class="text-slate-600 dark:text-slate-400 mb-4">
                            Generate an API key from your BillX GPS dashboard under Settings → API.
                        </p>
